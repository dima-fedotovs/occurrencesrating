 ...
 *
 */
public class SynchronizedOccurrencesRatingTest extends SimpleOccurrencesRatingTest {
    @Override
    protected OccurrencesRating<String> createNewRating(int capacity) {
        return new SynchronizedOccurrencesRating<>(super.createNewRating(capacity));
    }
}
