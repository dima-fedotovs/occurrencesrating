 ...
 *
 */
public class SynchronizedOccurrencesRatingLoadTest extends OccurrencesRatingLoadTest {

    @Override
    protected OccurrencesRating<String> createNewRating(int capacity) {
        return new SynchronizedOccurrencesRating<>(new SimpleOccurrencesRating<String>(capacity));
    }
}
